...
# Users
###
MF_USERS_LOG_LEVEL=info MF_EMAIL_TEMPLATE=../docker/users/emailer/templates/email.tmpl\ 
MF_EMAIL_VERIFY_TEMPLATE=../docker/users/emailer/templates/emailVerify.tmpl $BUILD_DIR/mainflux-users &
