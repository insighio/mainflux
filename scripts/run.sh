...
# Users
###
MF_USERS_LOG_LEVEL=info MF_USERS_ADMIN_EMAIL=admin@mainflux.com MF_USERS_ADMIN_PASSWORD=12345678 MF_EMAIL_TEMPLATE=../docker/templates/users.tmpl MF_EMAIL_VERIFY_TEMPLATE=../docker/users/emailer/templates/emailVerify.tmpl $BUILD_DIR/mainflux-users &
